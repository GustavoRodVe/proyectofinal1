...
export const Projects = ({
  ...
  const handleCloseProject = async () => {
    ...
    try {
      ...
      toast({
        variant: 'destructive',
        title: 'Error',
        description: 'No se pudo cerrar el proyecto. Intenta de nuevo.',
      });
    } finally {
  ...
  const handleReopenProject = async () => {
    ...
    try {
      ...
      toast({
        title: 'Éxito',
        description: 'Proyecto reabierto correctamente',
      });
    } catch (error) {
      toast({
        variant: 'destructive',
        title: 'Error',
        description: 'No se pudo reabrir el proyecto. Intenta de nuevo.',
      });
    } finally {
