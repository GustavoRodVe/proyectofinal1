...
export const Sizes = ({ projectId, items: initialItems }: Props) => {
  ...
  const handleSaveData = async () => {
    try {
      ...
      toast({
        title: 'Éxito',
        description: 'Tamaños actualizados correctamente',
      });
      await reloadSizes();
      ...
      toast({
        variant: 'destructive',
        title: 'Error',
        description: 'No se pudo guardar los tamaños',
      });
    } finally {
      setIsSaving(false);
    }
    ...
    <div>
      <div className="flex justify-end mb-2">
        <CreateCustomFieldOptionModal
          title="Crear nuevo tamaño"
          triggerLabel="Crear nueva opción de tamaño"
          handleSubmit={(data) =>
            setSizes((items) => [
              ...items,
