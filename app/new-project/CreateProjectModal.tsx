  ...
  return (
    <Dialog open={isModalOpen} onOpenChange={(open) => !open && closeModal()}>
      ...
      <DialogContent className="md:min-w-[90%] lg:min-w-[70%] max-h-screen overflow-auto">
        ...
        <DialogDescription>
          Personaliza las opciones predeterminadas para tu proyecto.
        </DialogDescription>
        <Separator />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[600px] overflow-y-auto p-2">
          <CustomFieldOptions
            ...
            embeddedCreateOptionEle={
              <CreateCustomFieldOptionModal
                title="Crear nueva opción de tamaño"
          ...
          <CustomFieldOptions
            ...
            embeddedCreateOptionEle={
              <CreateCustomFieldOptionModal
                title="Crear nueva opción de prioridad"
                handleSubmit={(data) =>
          ...
          <CustomFieldOptions
            ...
            embeddedCreateOptionEle={
              <CreateCustomFieldOptionModal
                title="Crear nueva opción de columna"
                handleSubmit={(data) =>
          ...
          <div>
            <div className="flex justify-between items-center">
              <h1 className="text-lg py-3">Etiquetas</h1>
              <Button
        ...
        <div className="flex gap-2 pt-4">
          ...
          />
          <Label>Omitir opciones predeterminadas. Crearé mis propias opciones</Label>
        </div>
